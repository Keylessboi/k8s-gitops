...
| `obsidian.sandstorm.chat` | Obsidian LiveSync — CouchDB-backed vault sync for desktop and mobile clients, no forward-auth (clients speak CouchDB directly) | CouchDB credentials from Doppler (`COUCHDB_USER`/`COUCHDB_PASSWORD`) |
